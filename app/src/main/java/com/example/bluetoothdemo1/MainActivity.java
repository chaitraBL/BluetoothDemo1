...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        listMainChat = findViewById(R.id.list_deviceListView);
        edCreateMessage = findViewById(R.id.et_EnterMessage);
...
//        {
//            Toast.makeText(context, "No bluetooth devices",Toast.LENGTH_SHORT).show();
//        }
//    }
//
//    @Override
...
//        if (requestCode == SELECT_DEVICE && resultCode == RESULT_OK) {
//            String address = data.getStringExtra("deviceAddress");
//            chatUtils.connect(mBluetoothAdapter.getRemoteDevice(address));
//        }
//        super.onActivityResult(requestCode, resultCode, data);
//    }
//
